    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2.5">
        <div className="flex flex-wrap gap-2 items-center">
          ...
          {canWrite &&
          <button onClick={() => setShowAjouter(true)} className="bg-transparent text-gray-200 px-4 py-2 font-thin text-center opacity-100 btn-glow-blue flex items-center gap-2 h-9">
